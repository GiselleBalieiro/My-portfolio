...
export default function Tab({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-20 z-50 rounded-4xl backdrop-blur-md bg-[--bg-primary]/80 border border-border-primary shadow-lg px-6 py-3 lg:static lg:bg-transparent lg:border-none lg:shadow-none lg:p-0 lg:pl-4 transition-all duration-300">
