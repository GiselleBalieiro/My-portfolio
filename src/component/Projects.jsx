    ...
    <>
      <div id="work" className="w-full px-[12%] py-10 scroll-mt-20 mt-[150px]">
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-5">
          <a href="https://expense-converter-three.vercel.app/" target="_blank">
            <div className="aspect-square bg-[url('./images/converter.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
              <div className="bg-white dark:bg-zinc-700 w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
                <div>
        ...
        <a
          ...
          target="_blank"
          className="w-max flex items-center justify-center gap-2 text-gray-700 dark:text-zinc-100 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-[#fcf4ff]"
        >
          Show more
