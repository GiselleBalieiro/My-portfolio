        ...
        <form action="" className="max-w-2xl mx-auto">
          <div className="grid grid-cols-2 gap-6 mt-10 mb-8">
            <input
              ...
              className="flex-1 p-3 outline-none border-[0.5px] border-gray-400 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-700"
            ></input>
            <input
              type="email"
          ...
          <textarea
            ...
            className="w-full p-4 outline-none border-[0.5px] border-gray-400 dark:border-zinc-600  rounded-md bg-white dark:bg-zinc-700 mb-6"
          ></textarea>
